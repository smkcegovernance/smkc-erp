...
function PrintInner() {
  ...
  const workDate = data.workOrderDate ? new Date(data.workOrderDate) : new Date()
  ...
  const authLine = data.manualFinalOrderNo
  ...
  return (
    <>
      <style>{`
        ...
        .header-title { font-size: 16pt; font-weight: 700; text-align: center; letter-spacing: 0.5px; margin-bottom: 1px; }
        .header-subtitle { text-align: center; font-size: 10pt; color: #333; margin-bottom: 2px; }
        .divider { border: none; border-top: 2px solid #000; margin: 4px 0 5px; }
        .no-date-row { display: flex; justify-content: space-between; font-size: 10.5pt; margin-bottom: 4px; }
        .doc-title { font-size: 13pt; font-weight: 700; text-align: center; text-decoration: underline; margin: 4px 0 6px; }
        .to-line { font-size: 11pt; margin-bottom: 3px; }
        .auth-line { font-size: 11pt; margin-bottom: 3px; }
        .work-label { font-size: 11pt; margin-top: 3px; }
        .work-name { font-weight: 700; font-size: 11pt; margin-bottom: 5px; }
        .body-para { text-align: justify; margin-bottom: 5px; font-size: 11pt; line-height: 1.45; }
        .bottom-row { margin-top: 16px; display: grid; grid-template-columns: 1fr 1fr 1fr; align-items: end; }
        .sign-col { grid-column: 3; text-align: center; font-size: 10.5pt; }
        .qr-col { grid-column: 2; display: flex; flex-direction: column; align-items: center; font-size: 8pt; color: #444; }
        .seal-area { text-align: center; margin-bottom: 2px; }
        .seal-area img { height: 68px; width: 68px; object-fit: contain; }
      `}</style>
      ...
      <div className="page">
        ...
        {/* Title */}
        <div className="doc-title">निविदा मंजुरीची कार्यादेश</div>
        ...
        <div className="body-para">
          अंदाज पत्रक रक्कम रुपये {fmtAmt(data.proposalAmount)}/- मात्रीची कामगिरी तुमचे नावे {fmtAmt(data.vendorProposedAmount)}/- दराने मंजूर करण्यात आले आहे. तरी त्याकरिता 7 दिवसांच्या आत स्थापत्य विभागाशी करारपत्र करून द्यावयाचे आहे. सदर कामगिरी महानगरपालिकेच्या अधिकृत नोंदणी प्राप्त ठेकेदाराकडून पूर्ण करून घेण्यात येईल. सदर काम {data.workPeriod} {data.periodType === 'month' ? 'महिन्यांत' : 'दिवसांत'} पूर्ण करण्याचे आहे. या कामाची मुदत संपल्यानंतर निर्धारित वेळेत काम पूर्ण न केल्यास महानगरपालिकेस वाटेल त्याप्रमाणे फेरनिविदा काढण्यात येईल. त्यामुळे जर या कामी महानगरपालिकेचे आर्थिक नुकसान होत असेल तर ते तुमच्याकडून कायदेशीर मार्गाने वसुलात आणले जाईल. या कामी करारपत्र करून देण्यास पुन्हा समज दिली जाणार नाही. सदरची कार्यादेश ही अंतिम समजणेची आहे. याची संबंधित ठेकेदार यांनी नोंद घ्यावी.
        </div>
        ...
        {data.nastiNo && (
          <div className="body-para">
            संदर्भ नस्ती क्रमांक: {data.nastiNo}
          </div>
        )}

        {/* Bottom: Signature (right) + QR Code (center) */}
        <div className="bottom-row">
          ...
          <div className="sign-col">
            ...
            {data.signingOfficerDesignation && (
              <div style={{ fontSize: '10.5pt', marginTop: 2 }}>{data.signingOfficerDesignation}</div>
            )}
            {data.deptName && (
              <div style={{ fontSize: '10.5pt', marginTop: 2 }}>{data.deptName}</div>
            )}
